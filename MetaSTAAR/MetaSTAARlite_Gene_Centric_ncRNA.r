...
file.dir <- c("~/noncoding_telo/STAAR/MetaSTAAR_Discovery_TOPMed/Discovery/Gene_Centric_ncRNA_Analysis/",
              "~/noncoding_telo/STAAR/MetaSTAAR_Discovery_TOPMed/TOPMed/Gene_Centric_ncRNA_Analysis/")
file.prefix <- c("10k_Cohort_rm_telo_qv_Gene_ncRNA_Analysis","TOPMed_Full_Cohort_grm_Gene_ncRNA_Analysis")
...
## output path
output_path <- "~/noncoding_telo/STAAR/MetaSTAAR_Discovery_TOPMed/ncRNA_Meta_Analysis/"
dir.create(output_path, recursive=T, showWarnings=F)
## output file name
output_file_name <- "ncRNAMeta"

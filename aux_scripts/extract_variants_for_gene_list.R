...
savenm <- paste0(savenm, "_sumstat_for_extracted_genes.Rdata")
savenm_full <- paste0(dir, "/",  savenm)
...
genes <- c('PPP1R3B', 'TERT', 'SPDL1', 'SAMD9L', 'GOT2', 'MUC5B', 'CDCA2', 'ARL2', 'RCC1L', 'RCC1L', 'RCC1L', 'CDCA3',
